...
#define EXAMPLE_PIN_NUM_DATA4          39   //
...
void LVGL_int()
{
  static lv_disp_draw_buf_t disp_buf; // contains internal graphic buffer(s) called draw buffer(s)
    ...
    esp_lcd_panel_io_i80_config_t io_config = {
        ...
        .flags = {
            .swap_color_bytes =   !LV_COLOR_16_SWAP ,//true, // Swap can be done in LvGL (default) or DMA       //A1A1
        },
...
LV_IMG_DECLARE(LVGL_EX);




void lv_example_img_date(void)
{
    
    lv_obj_t* img1 = lv_img_create(lv_scr_act());
    lv_img_set_src(img1, &LVGL_EX );
    lv_obj_align(img1, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_size(img1,480, 480);

 // lv_obj_t* img2 = lv_img_create(lv_scr_act());
//lv_img_set_src(img1, LV_SYMBOL_OK "Accept");
 // lv_obj_align_to(img2, img1, LV_ALIGN_OUT_BOTTOM_MID, 0, 20);jkk
}